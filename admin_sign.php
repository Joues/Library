...
<form action="" method="post" name="form2">
		<p><input type="text" name="name1" id="user" placeholder="用户名"></p>
		<p><input type="password" name="pwd1" id="pwd" placeholder="密码"></p>
        <span id="code" class="nocode">验证码</span> <input type="text" class="input" name="input" /> 
        <script src="js/jquery-1.12.3.min.js"></script>
        <script type="text/javascript" src="js/code.js"></script>  
		<p><input type="submit" name="submit1" id="submit" value="登录"></p>
...
if(isset($_POST["submit1"])&& $_POST["submit1"]=="登录"){	
    session_start();
    $_SESSION['name1'] = $_POST['name1'];
	if($_POST['name1'] == admin && $_POST['pwd1'] == admin888){
