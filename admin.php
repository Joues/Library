...
if(!isset($_SESSION['name1'])){
	echo "<script>alert('您不具备访问此网站的权限！');window.location.href='admin_sign.php';</script>";	
}
?>
<div class="header">
...
<tr><td width="5.5%">&nbsp;</td><td align="left" width="90%"><span class="date">当前用户：admin&nbsp;&nbsp;<b>当前时间: <span id="text" class="date"></span></b></span></td>
<td width="4.5%"><a href="admin_sign.php">注销登录</a></td></tr>
</table>
</div>
...
<table width="100%" height="38" border="0" cellpadding="0" cellspacing="0">
    ...
    <tr>
	  <td width="100" height="50" align="center" valign="middle"><a href="admin_sign.php" class="word1">退出系统</a></td></tr>
</table>
</div>
...
<tr>
  <td width="100%" height="30px" align="left" valign="top" class="word5"><a href="admin.php" >首页</a>> 图书管理</td></tr>
<tr>
    <tr>
...
?>
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
<form name="form1" id="form1" method="post" action="book_delete.php">
  <tr>
    <td height="20" width="5%" class="top" align="center">状态</td>
    <td width="5%" class="top" align="center">编号</td>
    <td width="15%" class="top" align="center">书名</td>
    <td width="5%" class="top" align="center">价格</td>
    <td width="10%" class="top" align="center">出版时间</td>
    <td width="10%" class="top" align="center">所属类别</td>
    <td width="10%" class="top" align="center">ISBN编码</td>
    <td width="15%" class="top" align="center">出版社</td>
	<td width="10%" class="top" align="center">操作</td>
  </tr>
<?php
    $pagesize = 7 ;									//每页显示记录数
	$sqlstr = "select * from tb_book order by book_id";
	...
	while ($rows = mysqli_fetch_row($result)){
		...
		echo "<td class='m_td' align='center' bgcolor='#669999'><a href=book_update.php?action=update&id=".$rows[0].">修改</a>/<a href=book_delete.php?action=del&book_id=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
<tr>
	<td height="25" width="800" colspan="9" class="m_td" align="left" bgcolor="#CCCC99">
