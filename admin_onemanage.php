...
<tr>
  <td width="100%" height="30px" align="left" valign="top" class="word3"><a href="admin.php">首页</a>> 读者管理</td></tr>
<tr>
    <tr>
...
?>
<table width="100%"  border="0" cellpadding="0" cellspacing="0">
<form name="form1" id="form1" method="post" action="one_delete.php">
  <tr>
    ...
    <td width="10%" class="top" align="center">读者证号</td>
    <td width="20%" class="top" align="center">密码</td>
    <td width="5%" class="top" align="center">身份类别</td>
	<td width="10%" class="top" align="center">电话</td>
    <td width="10%" class="top" align="center">注册日期</td>
    <td width="10%" class="top" align="center">操作</td>
  </tr>
<?php
    $pagesize = 7 ;									//每页显示记录数
	$sqlstr = "select * from tb_user order by id";
	...
	while ($rows = mysqli_fetch_row($result)){
		...
		echo "<td class='m_td' align='center' bgcolor='#669999'><a href=one_update.php?action=update&id=".$rows[0].">修改</a>/<a href=one_delete.php?action=del&id=".$rows[0]." onclick = 'return del();'>删除</a></td>";
		echo "</tr>";
	}
?>
<tr>
