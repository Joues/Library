...
?>
<center>
  <table width="797" height="155" border="0" cellpadding="0" cellspacing="0"  background="images/banner.jpg">
    <tr>
      <td>&nbsp;</td>
    </tr>
  </table>
...
<?php echo date("Y-m-d")." ";?></b></td>
      ...
      <td width="100" align="center" valign="middle"><a href="insert.php">添加图书</a></td>
      <td width="97" align="center" valign="middle"><a href="Sign.php">退出系统</a></td>
    </tr>
  </table>
<?php
