...
<form action="" method="post" name="form5">
  ...
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
    <td height="30" align="left"><input type="submit" name="submit" value="借阅"/></td>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
  </tr>
</table></td></tr>
...
if(isset($_POST['submit']) && $_POST['submit'] == "借阅"){
if ($_POST['name'] == "" || $_POST['book_name'] == ""){
	...
	$lendsql="insert into tb_bs(readID,name,book_name,begintime,lasttime) values('$readID','$name','".$_POST['book_name']."','$begintime','$lasttime')";
    mysqli_query($conn,$lendsql); 
	echo "<script language=javascript>alert('借阅完成')</script>";
}}
?>
</form>
  </td></tr>    </table>      
